...
window.charge_services_admin = function (element) {
    $(element).html('<i class="fa fa-spinner fa-spin" aria-hidden="true"></i>');
    $(element).attr('disabled', true);

    var formData = new FormData($("form#charge_services_form_admin")[0]);
    formData.append("_token", token);
    formData.append('store_id', $("form#charge_services_form_admin select#store_id").val());
