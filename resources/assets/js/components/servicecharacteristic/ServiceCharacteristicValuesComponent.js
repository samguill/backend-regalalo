...
export default class ServiceCharacteristicValuesComponent extends React.Component {
                                ...
                                <div className="row">
                                    <div className={"col-md-" + (this.state.updating ? 6 : 12)}>
                                        <a className="btn btn-success text-white btn-block" onClick={(e) => { this.storeBranch({
                                            ...
                                            service_characteristic_id: this.storeid
                                        })}}>
...
if (document.getElementsByClassName('service-characteristic-values')) {
    var elements = document.getElementsByClassName('service-characteristic-values');
    ...
    for(var i = 0; i < count; i++) {
        ...
        ReactDOM.render(<ServiceCharacteristicValuesComponent
            storeid={storeid}
