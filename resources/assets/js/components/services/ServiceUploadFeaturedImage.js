...
export default class ServiceUploadFeaturedImage extends React.Component {
...
if (document.getElementsByClassName('featured-image-service-component')) {
    var elements = document.getElementsByClassName('featured-image-service-component');
