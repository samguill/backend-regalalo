...
export default class ServiceImagesComponent extends React.Component {
...
if (document.getElementsByClassName('service-images-component')) {
    var elements=document.getElementsByClassName('service-images-component');
