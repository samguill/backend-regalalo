        ...
        <div class="col-md-12">
            <div class="card-body">
                <div class="accordion" id="accordion">
                    ...
                    <div class="card mb-20">
                        <button class="btn btn-link text-left" type="button" data-toggle="collapse" data-target="#collapse-posicionamiento" aria-expanded="true" aria-controls="collapse-posicionamiento">
                            <div class="card-header" id="heading-posicionamiento">
                                <h5 class="mb-0 d-inline-block">Datos de posicionamiento (SEO)</h5>
                                <i class="fa fa-angle-down float-lg-right" style="margin-right: 10px;" aria-hidden="true"></i>
                            </div>
                        </button>
                        <div id="collapse-posicionamiento" class="collapse show" aria-labelledby="heading-posicionamiento" data-parent="#accordion">
                            <div class="card-body">
